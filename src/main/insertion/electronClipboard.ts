...
const SAFE_METADATA_FORMATS = [
  /^org\.nspasteboard\.(?:transient|concealed|autogenerated)type$/i,
  /^com\.apple\.flat-rtfd$/i,
];
...
function isRestorableFormat(format: string): boolean {
  return [PLAIN_TEXT_FORMATS, HTML_FORMATS, RTF_FORMATS, IMAGE_FORMATS, SAFE_METADATA_FORMATS]
    .flat()
