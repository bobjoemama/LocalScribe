...
Whisper large-v3, Whisper large-v2, Qwen3-ASR 0.6B, and Qwen3-ASR 1.7B are
...
| Whisper large-v3 | MLX Whisper | High FP16, Medium 8-bit, Low 4-bit | After-stop | Multilingual catalog capabilities |
| Whisper large-v2 | MLX Whisper | High FP16, Medium 8-bit, Low 4-bit | After-stop | Multilingual catalog capabilities |
...
| Whisper large-v3 or large-v2 | 4.0-5.5 GiB | 2.5-3.5 GiB | 1.8-2.7 GiB |
...
The macOS Whisper large-v3 FP16 manifest declares MIT. The pinned large-v3
8-bit and 4-bit revisions and all three pinned
`mlx-community/whisper-large-v2-mlx` revisions have `Undeclared` license
metadata and require separate distribution review. The Qwen3-ASR model
repositories declare Apache-2.0. Each exact manifest remains authoritative;
do not infer a license from a related repository or runtime.
